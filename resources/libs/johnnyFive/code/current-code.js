'use strict';const jc = require('json-cycle'),chalk = require('chalk'),log = console.log;let five = require('johnny-five');try {let board = new five.Board({ port:'/dev/tty.usbmodem142101', repl: false, debug: false});board.on('ready', () => { try {let LED;
/**
 * Describe esta función...
 */
function Hacer_parpadear_LED() {
    LED = (new five.Led({
        pin: 8,
        custom: {
            type: 'LED',
