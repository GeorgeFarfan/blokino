'use strict';const jc = require('json-cycle'),chalk = require('chalk'),log = console.log;let five = require('johnny-five');try {let board = new five.Board({ port:'/dev/tty.usbmodem141101', repl: false, debug: false});board.on('ready', () => { try {let led;
led = (new five.Led({
    pin: 10,
    custom: {
        type: 'LED',
