    ...
    motorFunctions = {
            ...
            Blockly.Blocks["motor_new"] = {
                init: function() {
                    this.appendValueInput("pin")
                        .appendField(
                            new Blockly.FieldImage("../../images/blocks/motor.png", 40, 40, "*")
                        )
                        .setCheck("Number")
        ...
        code: Blockly => {
            ...
            Blockly.JavaScript["motor_spin_code"] = block => {
                ...
                let motor_code = Blockly.JavaScript.statementToCode(block, "code_spin_motor");
            ...
            Blockly.JavaScript["motor_stop_code"] = block => {
                ...
                let motor_code = Blockly.JavaScript.statementToCode(block, "code_stop");
