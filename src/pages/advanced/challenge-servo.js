                    ...
                    ipcRenderer.on("channel_one", (event, result) => {
                        if (result == "ErrorCallBack" || result == "Error" || result == "ErrorJ5") {
                            ...
                            if (
                                ...
                                data.variables_status.custom.code.state == "sweep-to-from" &&
                                data.variables_status.custom.code.positions.to == 50 &&
                                data.variables_status.custom.code.positions.from == 160
                            ) {
                                modalChallenges(
                                    data.status,
                                    current_test,
...
$("#carousel-test").bind("slide.bs.carousel", event => {
    if (
        ...
        clearScene(event.relatedTarget.dataset.pos, "ChallengeSERVOMOTORS");
    }
});
